  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
      <Card className="bg-gradient-to-br from-purple-light to-white hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
        ...
        <CardContent>
          <div className="text-2xl font-bold text-purple">$45,231</div>
          <div className="flex justify-between items-center">
            <p className="text-xs text-muted-foreground">+20.1% from last period</p>
            <div className="text-xs">
              <span className="text-success">Paid: $38,945</span>
              <span className="text-info ml-2">Free: 6,286</span>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="bg-gradient-to-br from-[#FEC6A1] to-white hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
        ...
        <CardContent>
          <div className="text-2xl font-bold text-warning">2,350</div>
          <div className="flex justify-between items-center">
            <p className="text-xs text-muted-foreground">+15% from last period</p>
            <div className="text-xs">
              <span className="text-success">Paid: 1,890</span>
              <span className="text-info ml-2">Free: 460</span>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="bg-gradient-to-br from-[#D3E4FD] to-white hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
        ...
        <CardContent>
          <div className="text-2xl font-bold text-info">348</div>
          <div className="flex justify-between items-center">
      ...
      <Card className="bg-gradient-to-br from-[#FFDEE2] to-white hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
        ...
        <CardContent>
          <div className="text-2xl font-bold text-danger">24</div>
          <div className="flex justify-between items-center">
